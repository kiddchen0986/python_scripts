...
from wrapper.run_native_test import run_checkerboard, run_reset_pixel

libc = None


def run_defective_pixels(check_image,
                         inv_check_image,
                         reset_image,
                         product_type,
                         hwid,
...
def run(dir_path, product_type_=None, hwid_=None):
    """Run defective_pixels test on all individual logs in the folder provided
    ...
    print("Run defective_pixel_test...")
    ...
    for id_, vals in logs.items():
        ...
        seq_packs.append(run_defective_pixels(checker_image,
                                              checker_inv_image,
                                              reset_image,
                                              product_type,
                                              hwid,
    ...
    csv.write_top_of_file(analyze_container, fp, "Defective pixel test", "", "", "Directory: {}".format(dir_path))
...
if __name__ == "__main__":
    ...
    # Parse user-input
    parser = argparse.ArgumentParser(description="Run the defective_pixel test on a directory of logs and images")
