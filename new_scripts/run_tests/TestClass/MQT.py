...
class Mqt2TestSettings(c.Structure):
    ...
    _fields_ = [
        ...
        #("fp_cropping_left", c.c_uint16),
        #("fp_cropping_top", c.c_uint16),
        #("fp_cropping_right", c.c_uint16),
        #("fp_cropping_bottom", c.c_uint16),
    ...
    def __init__(self):
        ...
        #self.fp_cropping_left = 4
        #self.fp_cropping_top = 4
        #self.fp_cropping_right = 4
        #self.fp_cropping_bottom = 4
    ...
    def set_mqt_test_criteria(self,
        ...
        #self.fp_cropping_left = fp_cropping_left
        #self.fp_cropping_top = fp_cropping_top
        #self.fp_cropping_right = fp_cropping_right
        #self.fp_cropping_bottom = fp_cropping_bottom
